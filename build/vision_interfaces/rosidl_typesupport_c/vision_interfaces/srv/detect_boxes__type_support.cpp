...
static const _DetectBoxes_Request_type_support_symbol_names_t _DetectBoxes_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_interfaces, srv, DetectBoxes_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_interfaces, srv, DetectBoxes_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vision_interfaces, srv, DetectBoxes_Request)() {
  return &::vision_interfaces::srv::rosidl_typesupport_c::DetectBoxes_Request_message_type_support_handle;
}
...
static const _DetectBoxes_Response_type_support_symbol_names_t _DetectBoxes_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_interfaces, srv, DetectBoxes_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_interfaces, srv, DetectBoxes_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vision_interfaces, srv, DetectBoxes_Response)() {
  return &::vision_interfaces::srv::rosidl_typesupport_c::DetectBoxes_Response_message_type_support_handle;
}
...
static const _DetectBoxes_Event_type_support_symbol_names_t _DetectBoxes_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_interfaces, srv, DetectBoxes_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_interfaces, srv, DetectBoxes_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vision_interfaces, srv, DetectBoxes_Event)() {
  return &::vision_interfaces::srv::rosidl_typesupport_c::DetectBoxes_Event_message_type_support_handle;
}
...
static const _DetectBoxes_type_support_symbol_names_t _DetectBoxes_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_interfaces, srv, DetectBoxes)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_interfaces, srv, DetectBoxes)),
  }
};
...
static const rosidl_service_type_support_t DetectBoxes_service_type_support_handle = {
  ...
  &DetectBoxes_Request_message_type_support_handle,
  &DetectBoxes_Response_message_type_support_handle,
  &DetectBoxes_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, vision_interfaces, srv, DetectBoxes)() {
  return &::vision_interfaces::srv::rosidl_typesupport_c::DetectBoxes_service_type_support_handle;
}
