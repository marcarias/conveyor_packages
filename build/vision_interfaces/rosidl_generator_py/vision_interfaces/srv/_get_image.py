...
class Metaclass_GetImage_Event(type):
    """Metaclass of message 'GetImage_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__get_image__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__get_image__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__get_image__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__get_image__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__get_image__event
...
class GetImage_Event(metaclass=Metaclass_GetImage_Event):
    """Message class 'GetImage_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<vision_interfaces/GetImage_Request, 1>',
        'response': 'sequence<vision_interfaces/GetImage_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['vision_interfaces', 'srv'], 'GetImage_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['vision_interfaces', 'srv'], 'GetImage_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from vision_interfaces.srv import GetImage_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, GetImage_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'GetImage_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from vision_interfaces.srv import GetImage_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, GetImage_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'GetImage_Response'"
...
class Metaclass_GetImage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'vision_interfaces.srv.GetImage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from vision_interfaces.srv import _get_image
            ...
            if _get_image.Metaclass_GetImage_Event._TYPE_SUPPORT is None:
                _get_image.Metaclass_GetImage_Event.__import_type_support__()


class GetImage(metaclass=Metaclass_GetImage):
    from vision_interfaces.srv._get_image import GetImage_Request as Request
    from vision_interfaces.srv._get_image import GetImage_Response as Response
    from vision_interfaces.srv._get_image import GetImage_Event as Event
