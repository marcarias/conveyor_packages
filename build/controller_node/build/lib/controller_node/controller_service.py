...
class ControllerNode(Node):
    def __init__(self):
        ...
        # Create service to trigger pipeline
        ...
        self.get_logger().info('Waiting for trigger... (call /trigger_capture service)')
    ...
    def trigger_callback(self, request, response):
        """Handle trigger service call - starts the pipeline"""
        self.get_logger().info('\n🚀 TRIGGER RECEIVED! Starting capture and processing...\n')
...
def main(args=None):
    ...
    try:
        # Keep the node spinning to handle service calls
        rclpy.spin(node)
