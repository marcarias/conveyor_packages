...
static const _ArrangePallet_Request_type_support_symbol_names_t _ArrangePallet_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_interfaces, srv, ArrangePallet_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_interfaces, srv, ArrangePallet_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vision_interfaces, srv, ArrangePallet_Request)() {
  return &::vision_interfaces::srv::rosidl_typesupport_c::ArrangePallet_Request_message_type_support_handle;
}
...
static const _ArrangePallet_Response_type_support_symbol_names_t _ArrangePallet_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_interfaces, srv, ArrangePallet_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_interfaces, srv, ArrangePallet_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vision_interfaces, srv, ArrangePallet_Response)() {
  return &::vision_interfaces::srv::rosidl_typesupport_c::ArrangePallet_Response_message_type_support_handle;
}
...
static const _ArrangePallet_Event_type_support_symbol_names_t _ArrangePallet_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_interfaces, srv, ArrangePallet_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_interfaces, srv, ArrangePallet_Event)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, vision_interfaces, srv, ArrangePallet_Event)() {
  return &::vision_interfaces::srv::rosidl_typesupport_c::ArrangePallet_Event_message_type_support_handle;
}
...
static const _ArrangePallet_type_support_symbol_names_t _ArrangePallet_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, vision_interfaces, srv, ArrangePallet)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, vision_interfaces, srv, ArrangePallet)),
  }
};
...
static const rosidl_service_type_support_t ArrangePallet_service_type_support_handle = {
  ...
  &ArrangePallet_Request_message_type_support_handle,
  &ArrangePallet_Response_message_type_support_handle,
  &ArrangePallet_Event_message_type_support_handle,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, vision_interfaces, srv, ArrangePallet)() {
  return &::vision_interfaces::srv::rosidl_typesupport_c::ArrangePallet_service_type_support_handle;
}
